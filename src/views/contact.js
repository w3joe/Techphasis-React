      ...
      <div className="contact-footer">
        <footer className="contact-footer1">
          <div className="contact-container1">
            <span className="contact-logo">TECHPHASIS</span>
            <nav className="contact-nav">
              <span className="contact-nav1">Home</span>
              <span className="contact-nav2">Services</span>
              <span className="contact-nav3">Portfolio</span>
              <span className="contact-nav4">Testimonials</span>
              <span className="contact-nav5">Contact</span>
            </nav>
          </div>
          <div className="contact-separator"></div>
          <div className="contact-container2">
            <span className="contact-text">© 2023 Techphasis</span>
